...
**A creative suite for live audio performance and stem manipulation, featuring the `reacoaxer` extension.**
...
Designed for live performers and workshop facilitators, `reacoaxer` acts as an intelligent companion, "coaxing" optimal performance from WAV stems through adaptive, low-latency feedback. It is the core tool in the `reaspunk` suite, enabling dynamic interaction during stage shows and private events.
...
- **Workshop Ready**: Ideal for stage shows, interactive installations, and dynamic audio environments.
